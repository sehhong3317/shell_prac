...
//lstat()와의 차이는 txt_link처럼 symbolic link를 넣었을 때, stat()은 링크가 참조하는
//원본 파일의 정보를 보여주는 반면, lstat()는 링크의 정보를 보여줌.
//비트연산을 통해, 여러가지 정보를 얻을 수 있음(man stat).
